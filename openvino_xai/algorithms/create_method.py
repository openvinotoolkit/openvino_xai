...
from openvino_xai.algorithms.black_box.black_box_methods import RISE, BlackBoxXAIMethodBase
from openvino_xai.algorithms.white_box.white_box_methods import ActivationMapXAIMethod, DetClassProbabilityMapXAIMethod, ReciproCAMXAIMethod, ViTReciproCAMXAIMethod, WhiteBoxXAIMethodBase
from openvino_xai.common.parameters import TaskType
from openvino_xai.common.utils import IdentityPreprocessFN, logger
from openvino_xai.insertion.insertion_parameters import ClassificationInsertionParameters, DetectionInsertionParameters, XAIMethodType
...
class WhiteBoxMethodFactory(MethodFactory):
    ...
    def create_method(
        ...
        **kwargs,
        ...
        raise ValueError(f"Model type {task_type} is not supported in white-box mode.")
...
class BlackBoxMethodFactory(MethodFactory):
    ...
    def create_method(
        ...
        **kwargs,
        ...
        raise ValueError(f"Model type {task_type} is not supported in black-box mode.")
