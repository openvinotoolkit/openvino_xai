...
def test_create_wb_cls_cnn_method():
    ...
    explain_method = WhiteBoxMethodFactory.create_method(TaskType.CLASSIFICATION, model_cnn, PREPROCESS_FN, insertion_parameters)
...
def test_create_wb_cls_vit_method():
    ...
    explain_method = WhiteBoxMethodFactory.create_method(TaskType.CLASSIFICATION, model_vit, PREPROCESS_FN, insertion_parameters)
...
def test_create_wb_det_cnn_method():
    ...
    explain_method = WhiteBoxMethodFactory.create_method(TaskType.DETECTION, model, PREPROCESS_FN, insertion_parameters)
    assert isinstance(explain_method, DetClassProbabilityMapXAIMethod)

    model = ov.Core().read_model(model_path)
    with pytest.raises(Exception) as exc_info:
        explain_method = WhiteBoxMethodFactory.create_method(TaskType.DETECTION, model, PREPROCESS_FN, insertion_parameters=None)
