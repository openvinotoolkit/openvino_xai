...
class TestDetProbMapXAI:
    ...
    _ref_sal_maps = {
        "det_mobilenetv2_atss_bccd": np.array([235, 202, 189, 198, 211, 210, 209, 208, 200, 193], dtype=np.uint8)
    }
    ...
    def setUp(self) -> None:
        """Setup the test case."""
        data_dir = Path(".data")
        # TODO: Create small model to use it as mocker
        # TODO: Add check that model with XAI branch is equal to reference graph
    ...
    def test_generate_xai_branch(self):
        ...
        assert xai_node_name in ["Reshape_57517", "Reshape_114962"]
